...
class BottomPanel extends React.Component {	
  ...
  fast() {
	...
	render() {
    let ssColor = this.props.ss ? "rgba(237, 167, 37,1)" : "rgba(0,0,0,1)";
    let mmColor = this.props.mm ? "rgba(237, 167, 37,1)" : "rgba(0,0,0,1)";
    let ffColor = this.props.ff ? "rgba(237, 167, 37,1)" : "rgba(0,0,0,1)";
    let ssStyle = {
      background: ssColor
    }
    let mmStyle = {
    ...
    let bsS = this.props.bsSmall ? "rgba(237, 167, 37,1)" : "rgba(0,0,0,1)";
    let bsM = this.props.bsMedium ? "rgba(237, 167, 37,1)" : "rgba(0,0,0,1)";
    let bsL = this.props.bsLarge ? "rgba(237, 167, 37,1)" : "rgba(0,0,0,1)";
    let bssStyle = {
      background: bsS
    }
    let bsmStyle = {
...
class Person extends React.Component {
  ...
  render() {
    let aliveColor = this.props.newPerson ? "rgba(237, 229, 78,1)" : "rgba(237, 167, 37, 1)";
