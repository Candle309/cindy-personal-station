...
app.use('/g_l_p', express.static(process.cwd()+'/game_of_life/public'));
app.use('/g_l_b', express.static(process.cwd()+'/game_of_life/build'));
app.use('/g_l_s', express.static(process.cwd()+'/game_of_life/src'));
